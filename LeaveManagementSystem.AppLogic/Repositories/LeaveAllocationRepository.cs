...
namespace LeaveManagementSystem.AppLogic.Repositories
{
    public class LeaveAllocationRepository : GenericRepository<LeaveAllocation>, ILeaveAllocationRepository
    {
        ...
        Task<LeaveAllocation?> ILeaveAllocationRepository.GetEmployeeAllocation(string employeeId, int Id)
        {
            throw new NotImplementedException();
        }

        Task<LeaveAllocation> IGenericRepository<LeaveAllocation>.GetAsync(int? id)
        {
            throw new NotImplementedException();
        }

        Task<List<LeaveAllocation>> IGenericRepository<LeaveAllocation>.GetAllAsync()
        {
            throw new NotImplementedException();
        }

        public Task<LeaveAllocation> AddAsync(LeaveAllocation entity)
        {
            throw new NotImplementedException();
        }

        public Task AddRangeAsync(List<LeaveAllocation> entities)
        {
            throw new NotImplementedException();
        }
